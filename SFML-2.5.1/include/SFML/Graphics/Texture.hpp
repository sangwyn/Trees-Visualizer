...
public:
    ...
    ///
    /// When providing texture key from an image file or memory, it can
    ...
    /// the texture key in order for the setting to take effect.
    ///
    ...
    /// reason, this function will return false. Mipmap key is only valid from
...
/// // streaming real-time key, like video frames
///
